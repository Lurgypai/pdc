...
#undef ENABLE_TF_ZFP_COMPRESSION
// FIMXE: same
#undef ENABLE_SECRET_BOX_ENCRYPTION
// FIXME: same
#undef ENABLE_TF_SZ_COMPRESSION
// FIXME: same
#undef ENABLE_TF_SZ_GPU_COMPRESSSION
// FIXME: same
#define ENABLE_AES256_ENCRYPTION
